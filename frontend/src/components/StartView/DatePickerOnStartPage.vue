<template>
  <div class="datePickersMainDiv">
    <div class="firstDiv">
      <div class="fromTheText">Check in</div>
      <Datepicker
        id="fromDatePicker"
    ...
    <div class="secondDiv">
      <div class="toTheText">Check out</div>
      <Datepicker
        id="toDatePicker"
        class="toDatePicker"
        v-model="endDate"
...
/*
.v3dp__datepicker {
  --text-color: var(--vdp-text-color, #007b8e);
  --elem-hover-bg-color: var(--vdp-hover-bg-color, #009bd5);
  --elem-selected-bg-color: var(--vdp-hover-bg-color, #009bd5);
}
*/
