    ...
    <div class="booking-view-container">
        ...
        <div class="location-maxguests">
          ...
          <div class="DivForGuests">
            <div class="guestsTitle">
              Here you can choose your guests:
            </div>
          ...
          <div class="buttonsDiv">
            <div class="cancelButtonDiv">
              <router-link to="/addLease">
                <button class="cancelButton" type="button" value="Edit">Cancel</button>
              </router-link>
            </div>
        </div>
      </div>
      <div v-if="myLease">
        <div class="location-maxguests">
          ...
          <div class="booking-view-images-container">
            <img v-if="myLease.imageURLs.length > 0" class="booking-view-image-1" :src="myLease.imageURLs[0]"/> 
            <img v-if="myLease.imageURLs.length > 1" class="booking-view-image-2" :src="myLease.imageURLs[1]" />
            <img v-if="myLease.imageURLs.length > 2" class="booking-view-image-3" :src="myLease.imageURLs[2]" />
            <img v-if="myLease.imageURLs.length > 3" class="booking-view-image-4" :src="myLease.imageURLs[3]" />
            <img v-if="myLease.imageURLs.length > 4" class="booking-view-image-5" :src="myLease.imageURLs[4]" />
          </div>
          <div class="type-price">
          ...
          <div class="myAmenities">
            <div class="wifiDiv">
              <div v-if="myLease.amenities[0] == 'wifi: true'" class="hasWifi">Wifi</div>
            </div>
            <div class="kitchenDiv">
              <div v-if="myLease.amenities[1] == 'kitchen: true'" class="hasKitchen">Kitchen</div>
            </div>
            <div class="washerDiv">
              <div v-if="myLease.amenities[2] == 'washer: true'" class="hasWasher0">Washer</div>
            </div>
            <div class="heatingDiv">
              <div v-if="myLease.amenities[3] == 'heating: true'" class="hasHeating">Heating</div>
            </div>
            <div class="acDiv">
              <div v-if="myLease.amenities[4] == 'airConditioner: true'" class="hasKitchen">Air Conditioning</div>
            </div>
          </div>
          <div class="amountOfBeds">
            <p class="bedsText">
