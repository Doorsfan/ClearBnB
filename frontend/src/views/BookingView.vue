  ...
  <div @click="mainWasClicked" class="booking-view-app-main">
    <div class="booking-view-container">
      ...
      <div class="PriceToPayInTotal">
        <p v-if="selectedNumberOfGuests > 0">
          Total price for {{ amountOfDays }} days for
        ...
        <p v-if="selectedNumberOfGuests == 0">
          Please select amount of guests to see the total price.
        </p>
      </div>
