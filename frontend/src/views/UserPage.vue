  ...
  <div class="primaryDiv">
    ...
    >
      ...
      <div class="historicalButtonDiv">
        <button
          @click="switchHistoricalDisplay"
          class="changeHistoricalDisplay"
        >
          Show Past Bookings
        </button>
      </div>
      <div class="currentBookingsDiv">
        <p class="yourFutureBookingsText">
          Your <b>CURRENT</b> bookings so far:
        </p>
        <div class="bookings">
          <FutureBookingsList
      ...
      <div class="residencesOutBox">
        <router-link class="residencesLink" to="/"
          >Your residences out for rent</router-link
        >
      </div>
        ...
        <div class="mainFormDiv">
          <div class="divForInputs">
            ...
            <div class="newsLetterInputDiv">
              <p class="newUserInfo">Newsletter:</p>
              <input
                type="checkbox"
  ...
  methods: {
    ...
    switchHistoricalDisplay() {
      if ($(".changeHistoricalDisplay").text() == "Show Past Bookings") {
        ...
        document.getElementsByClassName("currentBookingsDiv")[0].style.display =
          "none";
        document.getElementsByClassName("pastBookingsDiv")[0].style.display =
          "block";
      } else if (
        $(".changeHistoricalDisplay").text() == "Show Current Bookings"
      ) {
    ...
    changeUserInfo() {
      ...
      document.getElementsByClassName("changeUserInfoDiv")[0].style.display =
        "block";
    },
    redisplayUserPage() {
      document.getElementsByClassName("changeUserInfoDiv")[0].style.display =
...
.changeHistoricalDisplay,
.changeHistoricalDisplay:active {
...
.yourFutureBookingsText,
.yourPastBookingsText {
  margin-bottom: 20px;
